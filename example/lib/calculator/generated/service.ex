defmodule(Calculator.Generated.Service) do
  ...
  defmodule(DivideResponse) do
    ...
    _ = "0: i64 success"
    _ = "1: calculator.DivideByZeroException e"
    ...
    defmodule(BinaryProtocol) do
      ...
      defp(deserialize(<<12, 1::16-signed, rest::binary>>, acc)) do
        case(
          Elixir.Calculator.Generated.DivideByZeroException.BinaryProtocol.deserialize(rest)
        ) do
          {value, rest} ->
      ...
      def(serialize(%DivideResponse{success: success, e: e})) do
        [
          ...
          case(e) do
            ...
            _ ->
              [<<12, 1::16-signed>> | Calculator.Generated.DivideByZeroException.serialize(e)]
          end
          | <<0>>
        ]
      end
      ...
      case(
        ...
        {%Calculator.Generated.Service.DivideArgs{left: left, right: right}, ""} ->
          try do
            ...
            e in Calculator.Generated.DivideByZeroException ->
