defmodule(Calculator.Generated.Service) do
  ...
  defmodule(Binary.Framed.Client) do
    ...
    def(unquote(:vector_product)(client, left, right, type, rpc_opts \\ [])) do
      ...
      ClientImpl.call(client, "vectorProduct", serialized_args, VectorProductResponse.BinaryProtocol, rpc_opts)
    end
    def(unquote(:vector_product!)(client, left, right, type, rpc_opts \\ [])) do
        ...
        {%Calculator.Generated.Service.VectorProductArgs{left: left, right: right, type: type}, ""} ->
          try() do
            ...
            (
              ...
              {:reply, Elixir.Calculator.Generated.Service.VectorProductResponse.BinaryProtocol.serialize(response)}
            )
          rescue
            []
          catch
